    ...
    return {
      default: ({ children }: { children: React.ReactNode }) => {
        const client = useMemo(
          () => {
            // Force TCP transport to bypass UDP firewall blocks on port 3478
            try {
              AgoraRTC.setParameter('ENABLE_INSTANT_CONNECTIVITY', true);
              AgoraRTC.setParameter('AUDIO_WEBRTC_ENABLE_UNIFIED_PLAN', true);
            } catch (e) {
              // ignore unknown params on older SDK versions
            }
