...
export async function POST(request: Request) {
  try {
    ...
    let body: Partial<ClientStartRequest> = {};
    try {
      ...
      console.warn('Failed to parse body, using defaults', e);
    }
    const { requester_id = '0', channel_name = 'default', input_modalities = ['text'], output_modalities = ['text'] } =
      body;
